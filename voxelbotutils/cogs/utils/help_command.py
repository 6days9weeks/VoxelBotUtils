...
class HelpCommand(commands.MinimalHelpCommand):
    ...
    async def filter_commands_classmethod(
        ...
        valid_commands = [
            ...
            if i.hidden is False and i.enabled is True and i.name not in cls.HELP_COMMAND_NAMES
        ]
        returned_commands = []
    ...
    async def send_bot_help(
        self,
        mapping: typing.Dict[typing.Optional[commands.Cog], typing.List[commands.Command]],
    ):
        """
        ...
        if content:
            data.update(
                {"content": content.format(bot=self.context.bot, prefix=self.context.clean_prefix)}
            )
    ...
    def get_destination(self):
        ...
        if (
            ...
            and self.context.channel.permissions_for(self.context.author).manage_messages
        ):
